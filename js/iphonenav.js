   ...
   if(page == null) { return;}
    ...
    {        
        ...
        if (homeButton)
        {
						...
						if ((page.id) == "Leaderboard" || (page.id) == "Individual") {
							for (var i = 0; i < otherButtons.length; i++) {
								otherButtons[i].style.display = "inline";
							}
            ...
            //homeButton.style.display = (page.id) == "Leaderboard" || (page.id) == "Individual" ? "none" : "inline";
